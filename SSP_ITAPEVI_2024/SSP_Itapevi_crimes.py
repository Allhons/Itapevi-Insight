...
def run():
    ...
    with st.container():
        ...
        st.write("""
                ...
                Esse gráfico está alimentado com dados da ultima versão de Dados Criminais divulgados pela SSP de 2024.
                """)
        
        df = pd.read_excel("C:\\Users\\Allyson\\Desktop\\Itapevi Insights\\SSP_ITAPEVI\\SSP_itapevi.xlsx")
